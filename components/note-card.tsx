...
export const NoteCard = memo(
  function NoteCard({ note, folders, onClick, onToggleStar }: NoteCardProps) {
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-zinc-600 text-sm mb-3 line-clamp-2 sm:line-clamp-4 md:line-clamp-5 lg:line-clamp-6 overflow-hidden">
